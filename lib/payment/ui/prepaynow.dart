  ...
  void navigateToReviewLoanAccScreen() {
    Future.delayed(const Duration(seconds: 3), () {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => ReviewDisbursedAccMain(),
        ),
      );
    ...
    return SizedBox(
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(padding: EdgeInsets.only(left: 20.w, right: 20.w), child: SelectLoanOfferBtnUI(context)),
            ...
            children: [
              SizedBox(
                ...
                child: Checkbox(
                  ...
                  side: BorderSide(width: 1, color: ThemeHelper.getInstance()!.disabledColor),
                ),
              ),
              SizedBox(width: 10.w),
              Flexible(
    ...
    return Padding(
      ...
      child: Container(
        decoration: BoxDecoration(
            color: ThemeHelper.getInstance()?.colorScheme.secondary, borderRadius: BorderRadius.circular(12.r)),
                ...
                children: [
                  Text(
                    ...
                    style: ThemeHelper.getInstance()
                        ?.textTheme
                        .headline4
                        ?.copyWith(color: ThemeHelper.getInstance()?.colorScheme.tertiary, fontSize: 13.sp),
                  ),
                  Text(
                    '₹ 40,000',
  ...
  Widget LoanDetailsUI() {
    return Column(
      ...
      children: [
        ...
        LoanDetailCardUI("Amount overdue", '₹ 52,640', '(incl. late payment charges)', true),
        ...
        LoanDetailCardUI("Late payment charge", '2%', '(on outstanding dues)', true),
              ...
              Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                subText.isNotEmpty
                    ? Text(
                        subText,
                        style:
                            ThemeHelper.getInstance()?.textTheme.headline4?.copyWith(color: MyColors.PnbGrayTextColor),
                      )
                    : Container(
                        height: 0.h,
                      ),
