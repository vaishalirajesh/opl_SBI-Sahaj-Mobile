...
class Card2 extends StatefulWidget {
  Card2({Key? key, required this.flag, required this.index,this.outstanding_invoice,})
      : super(key: key);
  bool flag;
  int index;
            ...
            child: Row(
              children: [
                ...
                Text(
                  bankName??'',
                  style:
                      ThemeHelper.getInstance()!.textTheme.headline1!.copyWith(
                            fontSize: 13.sp,
                ...
                children: [
                  SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        ),style: ThemeHelper.getInstance()!.elevatedButtonTheme.style!.copyWith(foregroundColor:MaterialStatePropertyAll( MyColors.pnbcolorPrimary),backgroundColor: MaterialStatePropertyAll(MyColors.pnbPinkColor)),
                      ))
                ],
              )
            ],
                  ...
                  children: [
                    ...
                    Text(str_Due_date,
                        style: ThemeHelper.getInstance()!
                            ...
                            .headline3!
                            .copyWith(
                                fontSize: 12.sp, color: MyColors.pnbTextcolor)),
                    Text(dueDate?? '',
                        style: ThemeHelper.getInstance()!
                            .textTheme
                            .headline1!
