...
//                       ),
//                       Text(
//                         "Due in $dueDays ${int.parse(dueDays.toString() ?? "0") < 1 ? "Day" : "Days"}",
...
//             height: 10.h,
//           ),
//           setRowColumValueOpenCard("Disbursed On", disbursedDate ?? '-', "Lender", AppUtils.getBankFullName(bankName: bankName ?? '')),
...
//           setRowColumValueOpenCard("Tenure", '$tenure ${tenure == '0' ? 'Day' : 'Days'}', "Interest Amount", interestAmount ?? '0'),
//           widget.bottomWidget,
//         ],
//       ),
//     );
...
//             Text(
//               title1,
//               style: ThemeHelper.getInstance()!.textTheme.headline3!.copyWith(color: MyColors.pnbTextcolor, fontSize: 12.sp),
//             ),
//             Text(
//               value1,
//               style: ThemeHelper.getInstance()!.textTheme.headline2!.copyWith(color: MyColors.pnbcolorPrimary, fontSize: 12.sp),
//             ),
//           ],
//         ),
//         Column(
...
//               style: ThemeHelper.getInstance()!.textTheme.headline3!.copyWith(color: MyColors.pnbTextcolor, fontSize: 12.sp),
//             ),
//             Text(value2, style: ThemeHelper.getInstance()!.textTheme.headline2!.copyWith(color: MyColors.pnbcolorPrimary, fontSize: 12.sp)),
//           ],
//         ),
//       ],
//     );
...
//     try {
//       dueDate = disbursedInvoice?.dueDate ?? '';
//       disbursedDate = disbursedInvoice?.disbursedDate ?? '';
...
//     print("objectobjectobjectobjectobjectobjectobjectobjectobjectobjectobjectobjectobjectobjectobject");
//     if (date.isNotEmpty) {
