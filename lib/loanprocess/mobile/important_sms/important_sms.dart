...
class ImportantSMSMainBody extends State<ImportantSMSMains> {
          ...
          children: [
            Container(
              ...
              child: SvgPicture.asset(
                Utils.path(MOBILEBACKARROWBROWN), height: 20.h, width: 40.w,),)
          ],
        ),
      )
    ...
    return Center(
      child: Container(
        child: Column(
            ...
            children: [
              Image.asset(height: 127.h,Utils.path(IMPORTANTMAIL),fit: BoxFit.fill,),
  ...
  _buildMiddlerText() {
    return Column(children: [
      Text(str_Important_with_excl, style: ThemeHelper
          .getInstance()!
          .textTheme
          .headline1,)
      , SizedBox(height: 19.h,), Text(str_Important_sentence, style: ThemeHelper
          .getInstance()!
          .textTheme
        ...
        children: [
          ...
          //    Navigator.of(context).push(CustomRightToLeftPageRoute(child: LoaderPrepareLoanDisbursment(), ));
              Navigator.push(context,
                  MaterialPageRoute(builder: (context) => LoaderPrepareLoanDisbursment(),)
              );
