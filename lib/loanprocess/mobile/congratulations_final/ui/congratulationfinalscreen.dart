...
import 'package:sbi_sahay_1_0/utils/helpers/themhelper.dart';import '../../../../utils/constants/imageconstant.dart';
...
class CongratulationsFinalMainBody extends State<CongratulationsFinalMains> {
        ...
        child: Column(
            ...
            children: [
              Padding(
                ...
                child: Image.asset(height: 127.h,width: 166.w,Utils.path(RUPEELOADE),fit: BoxFit.fitHeight,),
              ),
  ...
  _buildTopContent(BuildContext context) {
    return Column(children: [
      Text(str_Congratulations_with_extre, style: ThemeHelper
          .getInstance()!
          .textTheme
          .headline1,),
      ...
      Padding(
        ...
        child: Row(
          ...
          children: [
            Flexible(
              flex: 1,
              child: Text(title, style: ThemeHelper
                  .getInstance()!
                  .textTheme
                  .headline2!
            ...
            Flexible(
              flex: 1,
              child: Text(value, style: ThemeHelper
                  .getInstance()!
                  .textTheme
                  .headline2!
                  .copyWith(color: MyColors.pnbcolorPrimary, fontSize: 16.sp),maxLines: 5,),
            ),
  ...
  Future<void> getDisbursementDetailAPI() async{
    ...
    GetDisbursedAccDetailRequest getDisbursedAccDetail = GetDisbursedAccDetailRequest( loanApplicationRefId: loanAppRefId,
    ...
    ServiceManager.getInstance().getDisbursementDetail(
        ...
        onSuccess: (response) => _onSuccessTriggerDisbursement(response), onError: (error) => _onErrorTriggerDisbursement(error));
  }
  ...
  _onSuccessTriggerDisbursement(GetDisburseDetailResponse? response) {
    ...
    if (response?.getDisburseDetailResOnj().status == RES_DETAILS_FOUND) {
      ...
      Navigator.pop(context);
      LoaderUtils.handleErrorResponse(context,response?.getDisburseDetailResOnj().status ,response?.getDisburseDetailResOnj().message,null);
    }
