...
class _BankListScreenState extends State<BankListScreen> {
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  text(text: strSelectYouDescr, textStyle: textTextHeader3Copywith11),
  ...
  Future<void> getBankListApi() async {
    ...
    ServiceManager.getInstance().getBankList(
  ...
  Future<void> getBankByCodeApi() async {
    ...
    ServiceManager.getInstance().getBankDetailByCode(
        request: tgGetRequest,
          ...
          children: [
            ...
            Row(
              children: [
                ...
                Text(
                    flag
                        ? this._searchResult[index]?.bankName ?? 'Bank not Available'
                        : this._bankListDetails[index]?.bankName ?? 'Bank not Available',
      ...
      onTap: () async {
        ...
        if (kIsWeb) {
          ...
          Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => BankListLoader(),
              ));
        } else {
    ...
    return SizedBox(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.all(Radius.circular(7.r))),
          enabledBorder: OutlineInputBorder(
              borderSide: BorderSide(color: ThemeHelper.getInstance()!.cardColor),
              borderRadius: BorderRadius.all(Radius.circular(7.r))),
          contentPadding: EdgeInsets.symmetric(vertical: 10.h),
          prefixIcon: Icon(Icons.search, color: ThemeHelper.getInstance()!.primaryColor),
      ...
      child: Column(
        ...
        children: [
          ...
          Image.asset(
            height: 80.h,
            width: 80.w,
            AppUtils.path(FINDING_AA_LINKBANK),
            fit: BoxFit.fill,
          ),
            ...
            child: Row(
              ...
              children: [
                ...
                Row(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: [
                    SvgPicture.asset(AppUtils.path(SMALLBANKLOGO), height: 20.h, width: 20.w),
                    SizedBox(
                      width: 5.w,
                    ),
                    SvgPicture.asset(AppUtils.path(MOBILESAHAYLOGO), height: 20.h, width: 20.w)
                  ],
                )
              ],
            ),
  ...
  onSearchTextChanged(String text) async {
    ...
    _bankListDetails.forEach((userDetail) {
      if (userDetail.bankName!.contains(text) || userDetail.bankCode!.contains(text)) _searchResult.add(userDetail);
    });
