...
class LenderSupportMainBody extends State<LenderSupportMains> {
  ...
  Widget LenderSupportScreen(BuildContext context) {
    return Scaffold(
      appBar: getAppBarWithTitle(str_contact_support, onClickAction: () => {Navigator.pop(context)}),
      body: Padding(
      ...
      children: [
        Row(
          ...
          children: [
            ...
            SvgPicture.asset(AppUtils.path(LOANCARDRIGHTARROW))
          ],
        ),
        SizedBox(
          height: 20.h,
        ...
        Divider(thickness: 1, color: ThemeHelper.getInstance()?.disabledColor),
      ],
    );
  }
