...
const MOBILE_CURRENT_ACC = 'images/ic_icon_cur_acc.svg';
const MOBILE_MOBILE_OTP = 'images/ic_icon_otp.svg';
...
const MOBILECONGRATULATION = 'images/congrulation_img.svg';
...
const MOBILERegistrationcompleted = 'images/registration_completed.png';
const LOANCARDRIGHTARROW = 'images/ic_icon_round_arrow_right.svg';
const RIGHTARROWFILLED = 'images/ic_icon_arrow_right_filled.svg';
const LOANCARDDOWNARROW = 'images/ic_icon_round_arrow_down.svg';
const LOANCARDUPARROW = 'images/ic_icon_round_arrow_up.svg';
const DOWNLOADKFS = 'images/ic_icon+download.svg';
const SANCTIONLIMIT = 'images/ic_icon_sanction_limit.svg';
...
const ABOUT = 'images/info_button_ic.svg';
const FAQ = 'images/faq_ic.svg';
const CONTACT = 'images/support_ic.svg';
const MOBILELOGOUT = 'images/logout_ic.svg';
const RIGHTARROWIC = 'images/right_arrow_white_ic.svg';
const DOWNARROWIC = 'images/down_arrow_brown_ic.svg';
...
const INFOSHARELOADER2 = 'gif/information_shared.gif';
const INFOSHARELOADER = 'jpg/information_shared.jpg';
const FETCHGSTLOADER1 = 'lottie/mobile_common_loader.json';
const FETCHGSTLOADER2 = 'gif/scanning_file.gif';
const FETCHGSTLOADER = 'jpg/scanning_file.jpg';
const NODATAFOUND = 'lottie/no_data_found.json';
const LOANOFFERLOADER = 'gif/jumping_jacks_1.gif';
const LOANOFFERLOADER1 = 'lottie/loan_offer_list.json';

const EMAILSEND1 = 'lottie/email_sent.json';
const EMAILSEND2 = 'gif/mail_sent.gif';
const EMAILSEND = 'jpg/mail_sent.jpg';
const CONGRATULATIONLOADE2 = 'gif/girl_meditating.gif';
const CONGRATULATIONLOADE = 'jpg/girl_meditating.jpg';
const CONGRATULATIONLOADE1 = 'lottie/practise_art_patience.json';
const RUPEELOADE1 = 'lottie/rupee.json';
const RUPEELOADE2 = 'gif/rupee.gif';
const RUPEELOADE = 'jpg/rupee.jpg';
const IMPORTANTMAIL1 = 'lottie/important_mail.json';
const IMPORTANTMAIL2 = 'gif/mail_sent.gif';
const IMPORTANTMAIL = 'jpg/mail_sent.jpg';
const LOANDISBURSED = 'jpg/rupee.jpg';
const LOANDISBURSED2 = 'gif/rupee.gif';
const LOANDISBURSED1 = 'lottie/loan_disbursed.json';
const RIDIRECT_AA_ONEMONEY1 = 'gif/girl_sitting_in_sofa.gif';
const RIDIRECT_AA_ONEMONEY = 'jpg/girl_sitting_in_sofa.jpg';
const FINDING_AA_LINKBANK1 = 'gif/bank_loader.gif';
const FINDING_AA_LINKBANK = 'jpg/bank_loader.jpg';
