...
class SbiThemes {
  static ThemeData sbiThemeMobile = ThemeData(
      ...
      appBarTheme: AppBarTheme(
          ...
          toolbarHeight: 60.h,
          titleSpacing: 0,
          titleTextStyle: TextUtils.getFontStyle(MyColors.pnbcolorPrimary, 16.sp, MyFont.Nunito_Sans_Semi_bold)),
      ...
      toggleableActiveColor: MyColors.pnbshadowcolor,
      textTheme: TextTheme(
        caption: TextUtils.getFontStyle(MyColors.white, 17.sp, MyFont.Nunito_Sans_Bold),
        headline1: TextUtils.getFontStyle(MyColors.pnbcolorPrimary, 23.sp, MyFont.Nunito_Sans_Bold),
        headline2: TextUtils.getFontStyle(MyColors.pnbsmallbodyTextColor, 18.sp, MyFont.Nunito_Sans_Semi_bold),
        headline3: TextUtils.getFontStyle(MyColors.pnbsmallbodyTextColor, 16.sp, MyFont.Nunito_Sans_Regular),
        headline4: TextUtils.getFontStyle(MyColors.pnbCheckboxTextColor, 13.sp, MyFont.Nunito_Sans_Regular),
        headline5: TextUtils.getFontStyle(MyColors.pnbTextcolor, 13.sp, MyFont.Nunito_Sans_Semi_bold),
        bodyText1: TextUtils.getFontStyle(MyColors.pnbcolorPrimary, 16.sp, MyFont.Nunito_Sans_Bold),
        bodyText2: TextUtils.getFontStyle(MyColors.pnbsmallbodyTextColor, 13.sp, MyFont.Nunito_Sans_Regular),
        button: TextUtils.getFontStyle(MyColors.white, 16.sp, MyFont.Nunito_Sans_Bold),
        headline6: TextUtils.getFontStyle(MyColors.pnbcolorPrimary, 13.sp, MyFont.Nunito_Sans_Bold),
        overline: TextUtils.getFontStyle(MyColors.pnbTextcolor, 13.sp, MyFont.Nunito_Sans_Regular),
      ),
      elevatedButtonTheme: ElevatedButtonThemeData(
        style: ElevatedButton.styleFrom(
          minimumSize: Size(double.infinity, 45.h),
