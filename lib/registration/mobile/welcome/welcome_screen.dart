              ...
              child: SingleChildScrollView(
                child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(str_welcome_pnb,style: ThemeHelper.getInstance()?.textTheme.headline1?.copyWith(fontSize: 20.sp),),
                        SizedBox(height: 10.h),
                        Text(str_keep_data_ready,style: ThemeHelper.getInstance()?.textTheme.bodyText2),
                        SizedBox(height: 20.h,),
                        schemeDataContainer(),
                        SizedBox(height: 20.h,),
                        Text(str_undertaking,style: ThemeHelper.getInstance()?.textTheme.bodyText1?.copyWith(color: Colors.black),),
                        SizedBox(height: 10.h,),
  ...
  Widget schemeDataContainer()
  {
    return Container(
      ...
      child: Padding(
          ...
          child: Column(
              children: [
                schemeDataRow(Utils.path(MOBILE_GST_LOGIN), str_gst_login_detail),
                Padding(
                ...
                schemeDataRow(Utils.path(MOBILE_CURRENT_ACC), str_cur_acc_with_pnb),
                Padding(
                  padding: EdgeInsets.only(top: 10.h,bottom: 10.h),
                  child: Divider(
                    color: MyColors.pnbWelcomeDivider.withOpacity(0.3),
                ...
                schemeDataRow(Utils.path(MOBILE_KYC_UPDATE), str_mobile_with_otp),
                Padding(
                  padding: EdgeInsets.only(top: 10.h,bottom: 10.h),
                  child: Divider(
                    color: MyColors.pnbWelcomeDivider.withOpacity(0.3),
                ...
                schemeDataRow(Utils.path(MOBILE_MOBILE_OTP), str_email_updated_kyc),
              ],
          ),
      ) ,
    );
  ...
  Widget schemeDataRow(String imagePath,String text)
  {
    return Row(
      ...
      children: [
        ...
        SizedBox(width: 10.w,),
        Flexible(child: Text(text,style: ThemeHelper.getInstance()?.textTheme.headline6?.copyWith(fontSize: 14.sp),maxLines: 10,))
      ],
    );
  }
      ...
      children: [
        Text(
          ...
          style: ThemeHelper
              .getInstance()
              ?.textTheme
              .headline3?.copyWith(fontSize: 12.sp),
        ),
        SizedBox(
          width: 5.w,
        ),
        Flexible(
            child: Text(
              ...
              style: ThemeHelper
                  .getInstance()
                  ?.textTheme
                  .headline3?.copyWith(fontSize: 13.sp),
              maxLines: 5,
            )),
      ],
    );
