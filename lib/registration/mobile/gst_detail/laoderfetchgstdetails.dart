...
class LoaderFetchGstDetailsState extends State<LoaderFetchGstDetailsBody> {
  ...
  Future<void> gstDetailsStatusAPI() async {
    FetGstDataStatusRequest fetGstDataStatusRequest = FetGstDataStatusRequest(
      id: "30AAACR9303A1Z6",
    );
  ...
  _onSuccessFetchGstDataStatus(FetchGstDataStatusResponse? response) {
